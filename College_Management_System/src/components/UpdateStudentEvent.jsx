...
const UpdateStudentEvent = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://college-management-system-r7p5.onrender.com/auth/admin/event/${event_id}`, {
            headers: {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`https://college-management-system-r7p5.onrender.com/auth/admin/admin-update-event/${event_id}`, {
            event_name,
            event_date,
            event_place,
            participants
...
export default UpdateStudentEvent;
