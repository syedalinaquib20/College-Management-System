...
const ManageAccount = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://college-management-system-0t6u.onrender.com/auth/student/account-management/${studentId}`, {
            headers: {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`https://college-management-system-0t6u.onrender.com/auth/student/update-password/${studentId}`, {
