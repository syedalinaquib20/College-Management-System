...
const ManageAccountAdmin = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://college-management-system-r7p5.onrender.com/auth/admin/account-management/${adminId}`, {
            headers: {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`https://college-management-system-r7p5.onrender.com/auth/admin/update-password/${adminId}`, {
