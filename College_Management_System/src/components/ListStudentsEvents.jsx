...
const ListStudentsEvents = () => {
    ...
    useEffect(() => {
        ...
        axios.get('https://college-management-system-r7p5.onrender.com/auth/admin/list-students-with-events', {
            headers: {
    ...
    const handleDelete = (studentId) => {
        const token = localStorage.getItem("token");
        axios.delete(`https://college-management-system-r7p5.onrender.com/auth/admin/admin-delete-student/${studentId}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        })
